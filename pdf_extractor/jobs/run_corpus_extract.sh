...
#SBATCH --mem=64G
#SBATCH --output=jobs/logs/corpus_%j.out
#SBATCH --error=jobs/logs/corpus_%j.err
...
CORPUS=/users/PGS0407/binben14/VietHuy/AECPlayGround-AGENT/RESEARCHER/outputs/fulltext_corpus
OUTPUT=/users/PGS0407/binben14/VietHuy/AECPlayGround-AGENT/RESEARCHER/outputs/extracted_paper
